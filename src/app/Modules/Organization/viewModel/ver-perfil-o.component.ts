...
export class VerPerfilOComponent implements OnInit {
      ...
      this.organizationService
        ...
        .subscribe(
          (organizationData) => {
            ...
            this.organizationService
              .getOrganizationHistory(organizationId)
              .subscribe(
                (historyData) => {
                ...
                (error) => {
                  console.error(
                    'Error al cargar el historial de la organización',
                    error
                  );
                }
              );
            ...
            this.organizationService
              .getOrganizationActivities(organizationId)
              .subscribe(
                (activitiesData) => {
                ...
                (error) => {
                  console.error(
                    'Error al cargar las actividades de la organización',
                    error
                  );
                }
              );
  ...
  unirseF(event: Event) {
    ...
    this.volunteerService
      .joinOrganization(this.volunteerId, this.organizationData.id)
      .subscribe(
        (response) => {
          this.showAlert = true;
