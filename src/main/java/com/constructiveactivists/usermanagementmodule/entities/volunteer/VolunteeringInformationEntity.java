...
@Table(name = "INFORMACION_VOLUNTARIADO", schema = "USERMANAGEMENT")
public class VolunteeringInformationEntity {
    ...
    @CollectionTable(name = "DIAS_DISPONIBLES", joinColumns = @JoinColumn(name = "INFORMACION_VOLUNTARIADO_ID"), schema = "USERMANAGEMENT")
    @Column(name = "DIA")
    private List<AvailabilityEnum> availabilityDaysList;

    @ElementCollection(targetClass = InterestEnum.class)
    @Enumerated(EnumType.STRING)
    @CollectionTable(name = "INTERESES_VOLUNTARIO", joinColumns = @JoinColumn(name = "INFORMACION_VOLUNTARIADO_ID"), schema = "USERMANAGEMENT")
    @Column(name = "INTERESES")
    private List<InterestEnum> interestsList;

    @ElementCollection(targetClass = SkillEnum.class)
    @Enumerated(EnumType.STRING)
    @CollectionTable(name = "HABILIDADES", joinColumns = @JoinColumn(name = "INFORMACION_VOLUNTARIADO_ID"), schema = "USERMANAGEMENT")
